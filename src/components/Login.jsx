...
export default function Login() {
  ...
  style={{
    boxShadow: "0 25px 50px rgba(0,0,0,0.5)", // dark shadow
  }}
>
        {/* Left side - Logo */}
        <div className="w-1/2 flex items-center justify-center bg-[#e5b141] p-10">
          <img src={Logo} alt="Logo" className="w-60 h-60" draggable={false} onContextMenu={(e) => e.preventDefault()}/>
        </div>

        {/* Right side - Login Form */}
        <div className="w-1/2 bg-[#dbd9d5]/90 p-10 flex flex-col justify-center shadow-inner">
          <h1 className="text-3xl font-bold text-[#56473a] mb-6 tracking-wide">Login</h1>
          <form className="space-y-5">
            <input
              type="email"
              placeholder="Email"
              className="w-full px-4 py-3 rounded-full bg-[#dbd9d5]/30 placeholder-[#56473a]/70 text-[#56473a] outline-none focus:ring-2 focus:ring-[#199b74] shadow-md transition"
            />
            <input
              type="password"
